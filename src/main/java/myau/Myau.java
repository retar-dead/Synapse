...
public class Myau {
    public static String clientName = "&7[&dSYN&7]&r ";
    ...
    public void init() {
        ...
        moduleManager.modules.put(AntiHulk.class, new AntiHulk());
        ...
        moduleManager.modules.put(ForceSlot.class, new ForceSlot());
        ...
        moduleManager.modules.put(Tag.class, new Tag());
        moduleManager.modules.put(Timers.class, new Timers());
        ...
        commandManager.commands.add(new myau.command.commands.CSkinCommand());
